...
-- INSERT data
    ...
    VALUES
        (true, 1, 1, '2019-1-25 17:0:38', 'Sagittis purus sit amet volutpat consequat mauris nunc congue.', 6000.0, 30.0, 5970.0, 'EUR'),
        ...
        (true, 2, 2, '2018-8-14 12:50:54', 'Orci eu lobortis elementum nibh tellus molestie.', 9000.0, 45.0, 8955.0, 'USD'),
        ...
        (true, 3, 3, '2019-6-17 17:46:5', 'Imperdiet dui accumsan sit amet nulla facilisi morbi.', 8000.0, 40.0, 7960.0, 'USD'),
        ...
        (true, 4, 4, '2020-7-1 18:16:5', 'Eu consequat ac felis donec et odio pellentesque.', 6000.0, 30.0, 5970.0, 'EUR'),
        ...
        (true, 5, 5, '2018-4-22 15:22:27', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 10000.0, 50.0, 9950.0, 'GBP'),
        ...
        (true, 6, 6, '2018-8-30 4:49:8', 'Pellentesque adipiscing commodo elit at.', 9000.0, 45.0, 8955.0, 'JPY'),
        ...
        (true, 7, 7, '2019-1-14 22:51:46', 'Tortor aliquam nulla facilisi cras fermentum odio eu.', 4000.0, 20.0, 3980.0, 'JPY'),
        (false, 10, 7, '2018-3-2 10:11:11', 'Ipsum consequat nisl vel pretium.', 306.43, 1.53, 304.9, 'JPY'),
        (true, 8, 8, '2020-2-8 9:33:36', 'Nec nam aliquam sem et tortor consequat id porta.', 6000.0, 30.0, 5970.0, 'EUR'),
        ...
        (true, 9, 9, '2020-5-11 5:16:49', 'Viverra ipsum nunc aliquet bibendum enim.', 1000.0, 5.0, 995.0, 'GBP'),
        ...
        (true, 10, 10, '2020-4-24 10:8:10', 'Pellentesque adipiscing commodo elit at.', 3000.0, 15.0, 2985.0, 'GBP'),
        ...
        (true, 11, 11, '2018-5-9 22:56:6', 'Tortor aliquam nulla facilisi cras fermentum odio eu.', 9000.0, 45.0, 8955.0, 'USD'),
        ...
        (true, 12, 12, '2018-10-3 4:28:44', 'Sapien et ligula ullamcorper malesuada proin libero.', 9000.0, 45.0, 8955.0, 'USD'),
        (false, 14, 12, '2018-4-22 2:59:6', 'Varius vel pharetra vel turpis nunc eget lorem dolor.', 55.94, 0.28, 55.66, 'USD'),
        (true, 13, 13, '2020-6-8 9:51:58', 'Viverra ipsum nunc aliquet bibendum enim.', 7000.0, 35.0, 6965.0, 'JPY'),
        ...
        (true, 14, 14, '2020-7-24 11:0:37', 'Imperdiet dui accumsan sit amet nulla facilisi morbi.', 5000.0, 25.0, 4975.0, 'EUR'),
        ...
        (true, 15, 15, '2019-6-19 0:2:19', 'Venenatis a condimentum vitae sapien pellentesque habitant morbi.', 5000.0, 25.0, 4975.0, 'JPY'),
        ...
        (true, 16, 16, '2019-7-27 7:46:13', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 8000.0, 40.0, 7960.0, 'EUR'),
        ...
        (true, 17, 17, '2020-4-29 1:12:3', 'Sagittis purus sit amet volutpat consequat mauris nunc congue.', 4000.0, 20.0, 3980.0, 'EUR'),
        ...
        (true, 18, 18, '2019-1-21 16:28:46', 'Viverra ipsum nunc aliquet bibendum enim.', 5000.0, 25.0, 4975.0, 'GBP'),
        ...
        (true, 19, 19, '2018-1-2 0:53:15', 'Ipsum consequat nisl vel pretium.', 8000.0, 40.0, 7960.0, 'USD'),
        (false, 19, 14, '2019-2-17 13:46:38', 'Tortor aliquam nulla facilisi cras fermentum odio eu.', 459.58, 2.3, 457.28, 'USD'),
        (true, 20, 20, '2019-8-10 6:38:23', 'Sem viverra aliquet eget sit amet tellus cras adipiscing enim.', 9000.0, 45.0, 8955.0, 'EUR'),
        ...
        (true, 21, 21, '2020-4-23 18:11:53', 'Imperdiet dui accumsan sit amet nulla facilisi morbi.', 5000.0, 25.0, 4975.0, 'GBP'),
        ...
        (true, 22, 22, '2020-6-5 1:1:29', 'Sagittis purus sit amet volutpat consequat mauris nunc congue.', 8000.0, 40.0, 7960.0, 'GBP'),
